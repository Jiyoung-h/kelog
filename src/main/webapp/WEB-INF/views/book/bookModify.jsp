...
function booklog_update(){
	...
	document.form1.action="${path}/book/update";
	...
	<div class="col-lg-9" style="margin-left: 300px;">
		...
		<div class="row">
			...
			<div class="col-6 movie-info" style="margin: 0 auto;">
				...
				<div> <span>출판일</span> <input type="date" name="releaseDate" value="${dto.releaseDate}"> </div>
				<div> <span>작가</span> <input name="author" value="${dto.author}"> </div>
				<div> <span>출판사</span> <input name="publisher" value="${dto.publisher}"> </div>
				<div> <span>독서 완료일</span> <input type="date" name="viewDate" value="${dto.viewDate}"> </div>
